...
![Heatmap of my London running](img/running/london-heatmap.png)
...
![Running in NYC](img/running/nyc-runs.png)
...
![VO2 max increasing with volume](img/running/vo2max.png)
